...
```mermaid
graph LR
    A[1. @项目经理<br/>项目规划] --> C[市场调研<br/>*可选*]
    A -.->|跳过调研| D
    C --> D[2. @产品经理<br/>PRD + 线框图]
    D --> QG1[3. @用户<br/>QG-01 确认]
    QG1 --> F[4. @UI/UX<br/>原型设计]
    QG1 --> G[5. @架构师<br/>架构设计]
    QG1 --> L[6. @AI 工程师<br/>AI 方案<br/>*如需要*]
    G --> QG2[7. @用户<br/>QG-02 确认]
    QG2 --> J[8. @前端<br/>使用 Mock]
    QG2 --> K[9. @后端<br/>提供 Mock]
    J --> M[10. 前后端联调]
    K --> M
    M --> QG3[11. @测试工程师<br/>QG-03 确认]
    QG3 --> N[12. @测试<br/>测试报告]
    N --> QG4[13. @用户<br/>QG-04 确认]
    QG4 --> P[14. @DevOps<br/>部署]
```
