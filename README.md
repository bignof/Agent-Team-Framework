...
```mermaid
graph LR
    A[1. @项目经理<br/>项目规划] --> B[2. @用户<br/>QG-01 评审]
    B --> C[3. @市场调研<br/>市场分析<br/>*可选*]
    C --> D[4. @产品经理<br/>PRD + 线框图]
    B -.->|跳过调研 | D
    D --> E[5. @用户<br/>QG-02 评审]
    E --> F[6. @UI/UX<br/>原型设计]
    E --> G[7. @架构师<br/>架构设计]
    F --> H[8. @用户<br/>QG-02.5 评审]
    G --> I[9. @用户<br/>QG-03 评审]
    H --> J[10. @前端<br/>页面实现]
    I --> K[11. @后端<br/>API 实现]
    I --> L[12. @AI 工程师<br/>AI 方案]
    J --> M[13. QG-04 检查]
    K --> M
    M --> N[14. @测试<br/>测试报告]
    N --> O[15. @用户<br/>QG-05 评审]
    O --> P[16. @DevOps<br/>部署]
```
